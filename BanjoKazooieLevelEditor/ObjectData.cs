...
namespace BanjoKazooieLevelEditor
{
  public class ObjectData : PickableObject
  {
    ...
    public static ObjectData clone(ObjectData o)
    {
      return new ObjectData(o.name, o.objectID, o.specialScript, o.pointer, o.pointer2, o.modelFile, o.modelFile2, o.cameraID, o.jiggyID)
      {
        type = o.type,
        radius = o.radius
      };
    ...
    public static ObjectData fullClone(ObjectData o)
    {
      return new ObjectData(o.name, o.objectID, o.specialScript, o.pointer, o.pointer2, o.modelFile, o.modelFile2, o.cameraID, o.jiggyID)
      {
        address = o.address,
