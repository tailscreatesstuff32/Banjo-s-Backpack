...
namespace BanjoKazooieLevelEditor
{
  internal class World
  {
    ...
    {
      return this.selectedCam != -1;
    }

    public CameraObject getSelectedCamera()
    {
      if (this.selectedCam == -1)
        throw new Exception("No camera selected");
      return this.cameras[this.selectedCam];
    }

    public bool hasSelectedNodes()
    {
      return this.selectedNodes.Count > 0 || this.selectedSNodes.Count > 0;
    }
    ...
    {
      return this.selectedCam == -1 ? -1 : this.cameras[this.selectedCam].type;
    }
    ...
    {
      return this.selectedObjects.Count > 0 || this.selectedStructs.Count > 0;
    }
    ...
    public ObjectData getSelectedObject()
    {
      return this.selectedObjects.Count <= 0 ? this.structs[this.selectedStructs[0]] : this.objects[this.selectedObjects[0]];
    }
    ...
    public void getRomStats(List<byte> F9CAE0)
    {
      try
      {
        ...
        for (int index = 33412; index < 34451; index += 8)
        {
          ...
          int pntr = 38776 + num1 * 8;
          ArrayList arrayList = this.setupFileReader.ReadSetupFile(RomHandler.DecompressFileToByteArray(pntr));
          if (num2 == 1)
          {
            this.MMLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.MMLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 2)
          {
            this.TTCLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.TTCLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 3)
          {
            this.CCLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.CCLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 4)
          {
            this.BGSLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.BGSLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 5)
          {
            this.FPLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.FPLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 6)
          {
            this.GLLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.GLLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 7)
          {
            this.GVLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.GVLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 8)
          {
            this.CCWLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.CCWLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 9)
          {
            this.RBBLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.RBBLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 10)
          {
            this.MMMLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.MMMLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 11)
          {
            this.SMLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.SMLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 12)
          {
            this.FBLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.FBLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
          if (num2 == 13)
          {
            this.CSLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[0]);
            this.CSLevelObjects.Add((object) pntr, (object) (List<ObjectData>) arrayList[1]);
          }
        }
      }
      catch (Exception ex)
...
label_17:
    ...
    private void getDistance(float[] a, float[] b)
    {
      Math.Sqrt(Math.Pow((double) a[0] - (double) b[0], 2.0) + Math.Pow((double) a[1] - (double) b[1], 2.0) + Math.Pow((double) a[2] - (double) b[2], 2.0));
    }
    ...
    private bool ObjectInDrawDistance(float x, float y, float z, GLCamera camera)
    {
      return Math.Sqrt(Math.Pow((double) x + (double) camera.X, 2.0) + Math.Pow((double) y + (double) camera.Y, 2.0) + Math.Pow((double) z + (double) camera.Z, 2.0)) <= (double) this.drawDistance;
    }
    ...
    public void renderPathPicking()
    {
      ...
      for (int index1 = 0; index1 < this.paths.Count; ++index1)
      {
        for (int index2 = 0; index2 < this.paths[index1].nodes.Count; ++index2)
        {
          if (this.paths[index1].nodes[index2].type == ObjectType.Path)
          {
            GL.Color3((float) this.paths[index1].nodes[index2].m_colorID[0] / (float) byte.MaxValue, (float) this.paths[index1].nodes[index2].m_colorID[1] / (float) byte.MaxValue, (float) this.paths[index1].nodes[index2].m_colorID[2] / (float) byte.MaxValue);
            this.core.DrawPriPick((float) this.paths[index1].nodes[index2].locX, (float) this.paths[index1].nodes[index2].locY, (float) this.paths[index1].nodes[index2].locZ);
          }
        }
      }
    ...
    public void selectBackBufferObject(byte[] pixel)
    {
      ...
      if (index1 == -1)
      {
        for (int index2 = 0; index2 < this.structs.Count; ++index2)
        {
          ObjectData objectData = this.structs[index2];
          if ((int) objectData.m_colorID[0] == (int) pixel[0] && (int) objectData.m_colorID[1] == (int) pixel[1] && (int) objectData.m_colorID[2] == (int) pixel[2])
          {
            index1 = index2;
            break;
    ...
    public void drawCameraPicking(CameraObject cam)
    {
      this.cameraPickDList.Add(this.core.drawCameraPicking(cam));
    }
    ...
    private void extractPaths()
    {
      try
      {
        ...
        while (nodes1.Count > 0)
        {
          ...
          {
            bool flag = false;
            for (int index2 = 0; index2 < bkPath.nodes.Count && !flag; ++index2)
            {
              if ((int) bkPath.nodes[index2].nodeOutUID == (int) nodes1[index1].uid)
              {
                bkPath.nodes.Add(nodes1[index1]);
                nodes1.RemoveAt(index1);
                index1 = -1;
                flag = true;
              }
              if (!flag && (int) nodes1[index1].nodeOutUID == (int) bkPath.nodes[index2].uid)
              {
                bkPath.nodes.Add(nodes1[index1]);
                nodes1.RemoveAt(index1);
                index1 = -1;
    ...
    public int GetListDec(string file_)
    {
      return this.setupFileReader.GetListDec(file_, 0);
    }
    ...
    public void AddCamera(CameraObject data_)
    {
      this.cameras.Add(data_);
    }

    public void DeleteAllStructs()
    {
      this.structs.Clear();
    }
