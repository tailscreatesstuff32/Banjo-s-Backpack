...
namespace BanjoKazooieLevelEditor
{
  public class Form1 : Form
  {
          ...
          if (xmlTextReader.NodeType != XmlNodeType.EndElement)
          {
            if (!(name == "menu"))
            {
              ...
              else
              {
                ...
                toolStripMenuItem3.Text = xmlTextReader.GetAttribute("name");
                ++index;
                toolStripMenuItemList.Add(toolStripMenuItem3);
                if (!flag || num1 == 0)
                {
                  intList.Add(num2);
                  ++num2;
    ...
    private int toPNTR(int u, int l)
    {
      return (int) this.rom[u] * 16777216 + (int) this.rom[u + 1] * 65536 + (int) (short) ((int) this.rom[l] * 256 + (int) this.rom[l + 1]);
    }
    ...
    private void KnowMoves(bool knowMoves)
    {
      ...
      FileStream fileStream1 = File.Create(this.outDir + "F37F90.bin");
      ...
      RomHandler.Rom = this.rom;
      this.locateEORFiles();
      FileStream fileStream2 = File.Create(this.inRom);
    ...
    private void PrepRom()
    {
      ...
      buffer[68145] = (byte) 0;
      buffer[395] = (byte) 145;
      FileStream fileStream1 = File.Create(this.outDir + "F19250.bin");
      BinaryWriter binaryWriter1 = new BinaryWriter((Stream) fileStream1);
      ...
      RomHandler.Rom = this.rom;
      this.locateEORFiles();
      uint baseRom = 66060288;
      byte[] f37f90;
      byte[] assets;
      new Globalizer(2151677952U, baseRom, this.rom).BeginUpdating(out f37f90, out assets);
      this.F37F90 = ((IEnumerable<byte>) f37f90).ToList<byte>();
      this.insertF37F90();
      this.romBuild.insertAsset(assets, (int) baseRom);
      this.rom = this.romBuild.rom;
      RomHandler.Rom = this.rom;
      this.locateEORFiles();
      FileStream fileStream2 = File.Create(this.inRom);
    ...
    private void save_tsmi_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        this.rom = this.romBuild.rom;
        FileStream fileStream = File.Create(this.inRom);
    ...
    private void saveAsRomToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        FileStream fileStream = File.Create(this.saveAsRomFileDialog.FileName);
        BinaryWriter binaryWriter = new BinaryWriter((Stream) fileStream);
    ...
    private void rectSelect_btn_Click(object sender, EventArgs e)
    {
    ...
    private void editMove_btn_Click(object sender, EventArgs e)
    {
      this.toggleMoveMode();
    }
    ...
    private void editRotate_btn_Click(object sender, EventArgs e)
    {
    ...
    private void duplicate_btn_Click(object sender, EventArgs e)
    {
    ...
    private void obj_move_btn_Click(object sender, EventArgs e)
    {
      this.toggleMoveMode();
    }

    private void obj_rot_btn_Click(object sender, EventArgs e)
    {
      this.toggleRotateMode();
    }

    private void obj_scale_btn_Click(object sender, EventArgs e)
    {
      this.toggleScaleMode();
    }

    private void obj_duplicate_btn_Click(object sender, EventArgs e)
    {
      this.toggleDuplicateMode();
    }

    private void cam_yaw_btn_Click(object sender, EventArgs e)
    {
      this.toggleYawMode();
    }

    private void cam_pitch_btn_Click(object sender, EventArgs e)
    {
      this.togglePitchMode();
    }

    private void cam_roll_btn_Click(object sender, EventArgs e)
    {
      this.toggleRollMode();
    }
    ...
    private void puzzleEditorToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      {
        FileStream fileStream = File.Create(this.outDir + "F37F90.bin");
        BinaryWriter binaryWriter = new BinaryWriter((Stream) fileStream);
    ...
    private void sNSEditorToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      binaryWriter1.Close();
      fileStream1.Close();
      FileStream fileStream2 = File.Create(this.outDir + "F9CAE0.bin");
      BinaryWriter binaryWriter2 = new BinaryWriter((Stream) fileStream2);
      ...
      RomHandler.Rom = this.rom;
      this.locateEORFiles();
      FileStream fileStream3 = File.Create(this.inRom);
    ...
    private void objectsFound_lv_DoubleClick(object sender, EventArgs e)
    {
      this.Refresh();
    }
    ...
    private void getEntryPoints()
    {
      ...
      int warp_ = -1;
      for (int loc_ = 50160; loc_ < 52392; loc_ += 4)
      {
        ++warp_;
        uint num = (uint) ((int) this.F9CAE0[loc_] * 16777216 + (int) this.F9CAE0[loc_ + 1] * 65536 + (int) this.F9CAE0[loc_ + 2] * 256) + (uint) this.F9CAE0[loc_ + 3] - 2147483648U - 2650000U;
        bool flag = true;
        for (int index = 0; index < source.Count<uint>(); ++index)
        {
          if ((int) source[index] == (int) num)
            flag = false;
        }
        if (flag)
        {
          try
          {
            ...
            for (int index = 0; index < 200 && (long) num + (long) index < (long) this.F37F90.Count<byte>(); ++index)
              file[index] = this.F37F90[(int) ((long) num + (long) index)];
            ...
            if (matchCollection.Count > 0)
            {
              ...
              if (match.Groups.Count == 3)
                this.entryPoints.Add(new LevelEntryPoint(Convert.ToByte(match.Groups[1].Value, 16), Convert.ToByte(match.Groups[2].Value, 16), (int) num, loc_, warp_));
            }
          }
          catch (Exception ex)
          {
    ...
    private void structsFound_lv_DoubleClick(object sender, EventArgs e)
    {
      this.Refresh();
    }
    ...
    private void createItem_MouseClick(object sender, EventArgs e)
    {
      ...
      {
        ObjectData o2 = new ObjectData((short) 336, 0, (short) world[0], (short) world[1], (short) world[2], (short) 0, (short) 100, (short) 25612);
        this.world.FillObjectDetails(ref o2);
        this.world.AddObj(o2);
      }
      ...
      if (e.Button == MouseButtons.Right)
      {
        ...
        else if (this.world.pathMode && !this.movingNode)
        {
          ...
          else if (this.world.pmode == PathMode.CreatePath || this.world.pmode == PathMode.CreateNode)
          {
            ...
            {
              int num1 = this.world.addNode(new ObjectData((short) 0, 0, (short) world[0], (short) (world[1] + (double) Convert.ToInt16(this.yOffset_tb.Text)), (short) world[2], (short) 0, (short) 100, (short) 6416)) ? 1 : 0;
              this.unlockPathSettings();
              if (num1 == 0)
              {
                int num2 = (int) MessageBox.Show("All paths used BB can't calculate any more");
    ...
    private void ShowGlobalPathButtons()
    {
      this.startNewPath_btn.Visible = true;
    }
    ...
    private void HideGlobalPathButtons()
    {
      this.startNewPath_btn.Visible = false;
    }
    ...
    {
      this.LevelViewer_KeyUp(sender, e);
    }
    ...
    {
      FileStream fileStream1 = File.Create(this.outDir + "F9CAE0.bin");
      BinaryWriter binaryWriter1 = new BinaryWriter((Stream) fileStream1);
    ...
    private void camMove_btn_Click(object sender, EventArgs e)
    {
      this.toggleCamMoveMode();
    }
    ...
    private void camDel_btn_Click(object sender, EventArgs e)
    {
      this.deleteSelected();
    }

    private void camDeselect_btn_Click(object sender, EventArgs e)
    {
      this.clearSelection();
    }
    ...
    private byte[] Int16ToByteArray(short s)
    {
      return new byte[2]{ (byte) ((uint) s >> 8), (byte) s };
    }
    ...
    {
      this.everyAnimation = BBXML.readAnimationsXML(false);
    ...
    private void deselectPath_btn_Click(object sender, EventArgs e)
    {
      this.clearSelection();
    }
    ...
    private void deselectPathToolStripMenuItem_Click(object sender, EventArgs e)
    {
      this.clearSelection();
    }
    ...
    private void drawDist_tb_Leave(object sender, EventArgs e)
    {
      this.world.drawDistance = Convert.ToSingle(this.drawDist_tb.Text);
    }
    ...
    private void InitializeComponent()
    {
            ...
            this.openRomToolStripMenuItem.Size = new System.Drawing.Size(315, 26);
            ...
            this.openSetupFileToolStripMenuItem.Size = new System.Drawing.Size(315, 26);
            ...
            this.loadSetupFileToolStripMenuItem.Size = new System.Drawing.Size(315, 26);
            ...
            this.saveSetupFileToolStripMenuItem.Size = new System.Drawing.Size(315, 26);
            ...
            this.save_tsmi.Size = new System.Drawing.Size(315, 26);
            ...
            this.saveAsRomToolStripMenuItem.Size = new System.Drawing.Size(315, 26);
            ...
            this.saveAsRomskillToolStripMenuItem.Size = new System.Drawing.Size(315, 26);
            ...
            this.knowAllMovesToolStripMenuItem.Size = new System.Drawing.Size(325, 26);
            ...
            this.haveNoMovesToolStripMenuItem.Size = new System.Drawing.Size(325, 26);
            ...
            this.includeCameraTriggersWhenSavingToolStripMenuItem.Size = new System.Drawing.Size(325, 26);
            ...
            this.removeNumbersFromNotedoorToolStripMenuItem.Size = new System.Drawing.Size(325, 26);
            ...
            this.hideUnknownBytesToolStripMenuItem.Size = new System.Drawing.Size(325, 26);
            ...
            this.importObjToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.modelEditorToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.textEditorToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.midiToolToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.puzzleEditorToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.injectorInToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.sNSEditorToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.spriteManagerToolStripMenuItem.Size = new System.Drawing.Size(235, 26);
            ...
            this.textUpdate_gb.Location = new System.Drawing.Point(4, 962);
            this.textUpdate_gb.Margin = new System.Windows.Forms.Padding(4);
            this.textUpdate_gb.Name = "textUpdate_gb";
            this.textUpdate_gb.Padding = new System.Windows.Forms.Padding(0);
            this.textUpdate_gb.Size = new System.Drawing.Size(267, 390);
            this.textUpdate_gb.TabIndex = 4;
            this.textUpdate_gb.TabStop = false;
            // 
            // updateRad_tb
            // 
            this.updateRad_tb.Location = new System.Drawing.Point(199, 76);
            this.updateRad_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateRad_tb.Name = "updateRad_tb";
            this.updateRad_tb.Size = new System.Drawing.Size(59, 22);
            ...
            this.rad_lbl.Location = new System.Drawing.Point(141, 80);
            this.rad_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.rad_lbl.Name = "rad_lbl";
            this.rad_lbl.Size = new System.Drawing.Size(52, 17);
            this.rad_lbl.TabIndex = 65;
            this.rad_lbl.Text = "Radius";
            // 
            // flag_tb
            // 
            this.flag_tb.Location = new System.Drawing.Point(77, 75);
            this.flag_tb.Margin = new System.Windows.Forms.Padding(4);
            this.flag_tb.Name = "flag_tb";
            this.flag_tb.Size = new System.Drawing.Size(59, 22);
            this.flag_tb.TabIndex = 16;
            // 
            // flag_lbl
            // 
            this.flag_lbl.AutoSize = true;
            this.flag_lbl.Location = new System.Drawing.Point(5, 76);
            this.flag_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.flag_lbl.Name = "flag_lbl";
            this.flag_lbl.Size = new System.Drawing.Size(35, 17);
            ...
            this.address_lbl.Location = new System.Drawing.Point(181, 354);
            this.address_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.address_lbl.Name = "address_lbl";
            this.address_lbl.Size = new System.Drawing.Size(27, 15);
            ...
            this.tableLayoutPanel4.Location = new System.Drawing.Point(-1, 228);
            ...
            this.tableLayoutPanel4.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
            this.tableLayoutPanel4.Size = new System.Drawing.Size(253, 87);
            ...
            this.updateB17_tb.Location = new System.Drawing.Point(193, 66);
            this.updateB17_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateB17_tb.Name = "updateB17_tb";
            this.updateB17_tb.Size = new System.Drawing.Size(56, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateB16_tb.Location = new System.Drawing.Point(67, 66);
            this.updateB16_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateB16_tb.Name = "updateB16_tb";
            this.updateB16_tb.Size = new System.Drawing.Size(55, 22);
            ...
            this.b10_lbl.Location = new System.Drawing.Point(4, 0);
            this.b10_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.b10_lbl.Name = "b10_lbl";
            this.b10_lbl.Size = new System.Drawing.Size(33, 17);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateB10_tb.Enabled = false;
            this.updateB10_tb.Location = new System.Drawing.Point(67, 4);
            this.updateB10_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateB10_tb.Name = "updateB10_tb";
            this.updateB10_tb.Size = new System.Drawing.Size(55, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateB18_tb.Enabled = false;
            this.updateB18_tb.Location = new System.Drawing.Point(193, 35);
            this.updateB18_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateB18_tb.Name = "updateB18_tb";
            this.updateB18_tb.Size = new System.Drawing.Size(56, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateB13_tb.Enabled = false;
            this.updateB13_tb.Location = new System.Drawing.Point(193, 4);
            this.updateB13_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateB13_tb.Name = "updateB13_tb";
            this.updateB13_tb.Size = new System.Drawing.Size(56, 22);
            ...
            this.b18_lbl.Location = new System.Drawing.Point(130, 31);
            this.b18_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.b18_lbl.Name = "b18_lbl";
            this.b18_lbl.Size = new System.Drawing.Size(33, 17);
            ...
            this.b11_lbl.Location = new System.Drawing.Point(4, 31);
            this.b11_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.b11_lbl.Name = "b11_lbl";
            this.b11_lbl.Size = new System.Drawing.Size(33, 17);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateB11_tb.Enabled = false;
            this.updateB11_tb.Location = new System.Drawing.Point(67, 35);
            this.updateB11_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateB11_tb.Name = "updateB11_tb";
            this.updateB11_tb.Size = new System.Drawing.Size(55, 22);
            ...
            this.b13_lbl.Location = new System.Drawing.Point(130, 0);
            this.b13_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.b13_lbl.Name = "b13_lbl";
            this.b13_lbl.Size = new System.Drawing.Size(33, 17);
            ...
            this.b16_lbl.Location = new System.Drawing.Point(4, 62);
            this.b16_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.b16_lbl.Name = "b16_lbl";
            this.b16_lbl.Size = new System.Drawing.Size(33, 17);
            ...
            this.b17_lbl.Location = new System.Drawing.Point(130, 62);
            this.b17_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.b17_lbl.Name = "b17_lbl";
            this.b17_lbl.Size = new System.Drawing.Size(33, 17);
            ...
            this.tableLayoutPanel3.Location = new System.Drawing.Point(-1, 123);
            ...
            this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
            this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
            this.tableLayoutPanel3.Size = new System.Drawing.Size(253, 102);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateX_tb.Enabled = false;
            this.updateX_tb.Location = new System.Drawing.Point(29, 4);
            this.updateX_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateX_tb.Name = "updateX_tb";
            this.updateX_tb.Size = new System.Drawing.Size(69, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateY_tb.Enabled = false;
            this.updateY_tb.Location = new System.Drawing.Point(29, 38);
            this.updateY_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateY_tb.Name = "updateY_tb";
            this.updateY_tb.Size = new System.Drawing.Size(69, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateZ_tb.Enabled = false;
            this.updateZ_tb.Location = new System.Drawing.Point(29, 72);
            this.updateZ_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateZ_tb.Name = "updateZ_tb";
            this.updateZ_tb.Size = new System.Drawing.Size(69, 22);
            ...
            this.size_lbl.Location = new System.Drawing.Point(106, 0);
            this.size_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.size_lbl.Name = "size_lbl";
            this.size_lbl.Size = new System.Drawing.Size(35, 17);
            ...
            this.rotByte_lbl.Location = new System.Drawing.Point(106, 34);
            this.rotByte_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.rotByte_lbl.Name = "rotByte_lbl";
            this.rotByte_lbl.Size = new System.Drawing.Size(61, 17);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateSize_tb.Enabled = false;
            this.updateSize_tb.Location = new System.Drawing.Point(181, 4);
            this.updateSize_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateSize_tb.Name = "updateSize_tb";
            this.updateSize_tb.Size = new System.Drawing.Size(68, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.updateRot_tb.Enabled = false;
            this.updateRot_tb.Location = new System.Drawing.Point(181, 38);
            this.updateRot_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateRot_tb.Name = "updateRot_tb";
            this.updateRot_tb.Size = new System.Drawing.Size(68, 22);
            ...
            this.cc_failsafe_cb.Location = new System.Drawing.Point(181, 72);
            this.cc_failsafe_cb.Margin = new System.Windows.Forms.Padding(4);
            this.cc_failsafe_cb.Name = "cc_failsafe_cb";
            this.cc_failsafe_cb.Size = new System.Drawing.Size(41, 25);
            ...
            // failsafe_lbl
            // 
            this.failsafe_lbl.Location = new System.Drawing.Point(106, 68);
            this.failsafe_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.failsafe_lbl.Name = "failsafe_lbl";
            this.failsafe_lbl.Size = new System.Drawing.Size(67, 25);
            ...
            this.objID_lbl.Location = new System.Drawing.Point(17, 354);
            this.objID_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.objID_lbl.Name = "objID_lbl";
            this.objID_lbl.Size = new System.Drawing.Size(35, 15);
            ...
            // id_tb
            // 
            this.id_tb.Location = new System.Drawing.Point(77, 48);
            this.id_tb.Margin = new System.Windows.Forms.Padding(4);
            this.id_tb.Name = "id_tb";
            this.id_tb.Size = new System.Drawing.Size(59, 22);
            ...
            this.label1.Location = new System.Drawing.Point(121, 353);
            ...
            // warp_btn
            // 
            this.warp_btn.Location = new System.Drawing.Point(217, 322);
            this.warp_btn.Margin = new System.Windows.Forms.Padding(4);
            this.warp_btn.Name = "warp_btn";
            this.warp_btn.Size = new System.Drawing.Size(35, 25);
            ...
            // warpTo_tb
            // 
            this.warpTo_tb.Location = new System.Drawing.Point(77, 325);
            this.warpTo_tb.Margin = new System.Windows.Forms.Padding(4);
            this.warpTo_tb.Name = "warpTo_tb";
            this.warpTo_tb.Size = new System.Drawing.Size(124, 22);
            this.warpTo_tb.TabIndex = 27;
            // 
            // warpTo_lbl
            // 
            this.warpTo_lbl.AutoSize = true;
            this.warpTo_lbl.Location = new System.Drawing.Point(12, 327);
            this.warpTo_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.warpTo_lbl.Name = "warpTo_lbl";
            this.warpTo_lbl.Size = new System.Drawing.Size(70, 17);
            ...
            this.id_lbl.Location = new System.Drawing.Point(4, 48);
            this.id_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.id_lbl.Name = "id_lbl";
            this.id_lbl.Size = new System.Drawing.Size(66, 17);
            this.id_lbl.TabIndex = 41;
            this.id_lbl.Text = "Object ID";
            // 
            // updateScript_tb
            // 
            this.updateScript_tb.Location = new System.Drawing.Point(199, 48);
            this.updateScript_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateScript_tb.Name = "updateScript_tb";
            this.updateScript_tb.Size = new System.Drawing.Size(59, 22);
            ...
            // 
            this.updateName_tb.Enabled = false;
            this.updateName_tb.Location = new System.Drawing.Point(63, 16);
            this.updateName_tb.Margin = new System.Windows.Forms.Padding(4);
            this.updateName_tb.Name = "updateName_tb";
            this.updateName_tb.Size = new System.Drawing.Size(195, 22);
            this.updateName_tb.TabIndex = 13;
            // 
            // script_lbl
            // 
            this.script_lbl.AutoSize = true;
            this.script_lbl.Location = new System.Drawing.Point(141, 48);
            this.script_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.script_lbl.Name = "script_lbl";
            this.script_lbl.Size = new System.Drawing.Size(44, 17);
            ...
            // changeLM_btn
            // 
            this.changeLM_btn.Location = new System.Drawing.Point(125, 95);
            this.changeLM_btn.Margin = new System.Windows.Forms.Padding(4);
            this.changeLM_btn.Name = "changeLM_btn";
            this.changeLM_btn.Size = new System.Drawing.Size(100, 28);
            ...
            // objectMenu
            // 
            this.objectMenu.ImageScalingSize = new System.Drawing.Size(20, 20);
            ...
            this.CamSpeed_tb.Location = new System.Drawing.Point(1385, 2);
            ...
            this.baseLevel_tb.Location = new System.Drawing.Point(91, 25);
            this.baseLevel_tb.Margin = new System.Windows.Forms.Padding(4);
            this.baseLevel_tb.Name = "baseLevel_tb";
            this.baseLevel_tb.Size = new System.Drawing.Size(103, 22);
            this.baseLevel_tb.TabIndex = 64;
            // 
            // extraModel_tb
            // 
            this.extraModel_tb.Enabled = false;
            this.extraModel_tb.Location = new System.Drawing.Point(91, 59);
            this.extraModel_tb.Margin = new System.Windows.Forms.Padding(4);
            this.extraModel_tb.Name = "extraModel_tb";
            this.extraModel_tb.Size = new System.Drawing.Size(103, 22);
            ...
            // replaceModelEx_btn
            // 
            this.replaceModelEx_btn.Location = new System.Drawing.Point(203, 60);
            this.replaceModelEx_btn.Margin = new System.Windows.Forms.Padding(4);
            this.replaceModelEx_btn.Name = "replaceModelEx_btn";
            this.replaceModelEx_btn.Size = new System.Drawing.Size(41, 28);
            ...
            // replaceModel_btn
            // 
            this.replaceModel_btn.Location = new System.Drawing.Point(203, 22);
            this.replaceModel_btn.Margin = new System.Windows.Forms.Padding(4);
            this.replaceModel_btn.Name = "replaceModel_btn";
            this.replaceModel_btn.Size = new System.Drawing.Size(41, 28);
            ...
            this.replacemodel_gb.Location = new System.Drawing.Point(4, 1889);
            this.replacemodel_gb.Margin = new System.Windows.Forms.Padding(4);
            this.replacemodel_gb.Name = "replacemodel_gb";
            this.replacemodel_gb.Padding = new System.Windows.Forms.Padding(4);
            this.replacemodel_gb.Size = new System.Drawing.Size(267, 130);
            this.replacemodel_gb.TabIndex = 5;
            this.replacemodel_gb.TabStop = false;
            // 
            // clear_btn
            // 
            this.clear_btn.Location = new System.Drawing.Point(17, 96);
            ...
            this.flowLayoutPanel1.Location = new System.Drawing.Point(1280, 194);
            this.flowLayoutPanel1.Margin = new System.Windows.Forms.Padding(4);
            this.flowLayoutPanel1.Name = "flowLayoutPanel1";
            this.flowLayoutPanel1.Size = new System.Drawing.Size(310, 422);
            ...
            this.path_gb.Location = new System.Drawing.Point(4, 4);
            this.path_gb.Margin = new System.Windows.Forms.Padding(4);
            this.path_gb.Name = "path_gb";
            this.path_gb.Padding = new System.Windows.Forms.Padding(4);
            this.path_gb.Size = new System.Drawing.Size(281, 922);
            ...
            this.pathControllers_dgv.Location = new System.Drawing.Point(8, 246);
            this.pathControllers_dgv.Margin = new System.Windows.Forms.Padding(4, 4, 4, 37);
            ...
            this.pathControllers_dgv.Size = new System.Drawing.Size(263, 98);
            ...
            this.nodeID_gb.Location = new System.Drawing.Point(4, 351);
            this.nodeID_gb.Margin = new System.Windows.Forms.Padding(4);
            this.nodeID_gb.Name = "nodeID_gb";
            this.nodeID_gb.Size = new System.Drawing.Size(267, 105);
            ...
            this.tableLayoutPanel13.Location = new System.Drawing.Point(0, 31);
            this.tableLayoutPanel13.Margin = new System.Windows.Forms.Padding(0);
            this.tableLayoutPanel13.Name = "tableLayoutPanel13";
            this.tableLayoutPanel13.RowCount = 2;
            this.tableLayoutPanel13.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 50F));
            this.tableLayoutPanel13.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 50F));
            this.tableLayoutPanel13.Size = new System.Drawing.Size(267, 68);
            ...
            this.nodeID_tb.Location = new System.Drawing.Point(105, 5);
            this.nodeID_tb.Margin = new System.Windows.Forms.Padding(4);
            this.nodeID_tb.Name = "nodeID_tb";
            this.nodeID_tb.Size = new System.Drawing.Size(157, 22);
            this.nodeID_tb.TabIndex = 18;
            // 
            // label70
            // 
            this.label70.AutoSize = true;
            this.label70.Location = new System.Drawing.Point(5, 34);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.node18_tb.Location = new System.Drawing.Point(105, 38);
            this.node18_tb.Margin = new System.Windows.Forms.Padding(4);
            this.node18_tb.Name = "node18_tb";
            this.node18_tb.Size = new System.Drawing.Size(157, 22);
            ...
            this.button6.Size = new System.Drawing.Size(265, 31);
            ...
            this.sNode_gb.Location = new System.Drawing.Point(5, 591);
            this.sNode_gb.Margin = new System.Windows.Forms.Padding(4);
            this.sNode_gb.Name = "sNode_gb";
            this.sNode_gb.Size = new System.Drawing.Size(267, 300);
            ...
            this.tableLayoutPanel2.Size = new System.Drawing.Size(265, 261);
            this.tableLayoutPanel2.TabIndex = 84;
            // 
            // label61
            // 
            this.label61.AutoSize = true;
            this.label61.Location = new System.Drawing.Point(5, 34);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.sNodeF_tb.Location = new System.Drawing.Point(95, 38);
            this.sNodeF_tb.Margin = new System.Windows.Forms.Padding(4);
            this.sNodeF_tb.Name = "sNodeF_tb";
            this.sNodeF_tb.Size = new System.Drawing.Size(165, 22);
            ...
            // pathID_tb
            // 
            this.pathID_tb.Location = new System.Drawing.Point(95, 5);
            this.pathID_tb.Margin = new System.Windows.Forms.Padding(4);
            this.pathID_tb.Name = "pathID_tb";
            this.pathID_tb.Size = new System.Drawing.Size(163, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.sNodeUNK3_tb.Location = new System.Drawing.Point(95, 194);
            this.sNodeUNK3_tb.Margin = new System.Windows.Forms.Padding(4);
            this.sNodeUNK3_tb.Name = "sNodeUNK3_tb";
            this.sNodeUNK3_tb.Size = new System.Drawing.Size(165, 22);
            ...
            this.label67.Location = new System.Drawing.Point(5, 190);
            ...
            this.panel1.Location = new System.Drawing.Point(95, 71);
            ...
            this.useAnimation_cb.Location = new System.Drawing.Point(3, 5);
            this.useAnimation_cb.Margin = new System.Windows.Forms.Padding(4);
            this.useAnimation_cb.Name = "useAnimation_cb";
            this.useAnimation_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.animation_cb.Location = new System.Drawing.Point(28, 1);
            this.animation_cb.Margin = new System.Windows.Forms.Padding(4);
            this.animation_cb.Name = "animation_cb";
            this.animation_cb.Size = new System.Drawing.Size(132, 21);
            ...
            this.panel2.Size = new System.Drawing.Size(164, 33);
            this.panel2.TabIndex = 80;
            // 
            // usePause_cb
            // 
            this.usePause_cb.AutoSize = true;
            this.usePause_cb.Location = new System.Drawing.Point(3, 4);
            this.usePause_cb.Margin = new System.Windows.Forms.Padding(4);
            this.usePause_cb.Name = "usePause_cb";
            this.usePause_cb.Size = new System.Drawing.Size(18, 17);
            ...
            // pauseTime_tb
            // 
            this.pauseTime_tb.Location = new System.Drawing.Point(28, 2);
            this.pauseTime_tb.Margin = new System.Windows.Forms.Padding(4);
            this.pauseTime_tb.Name = "pauseTime_tb";
            this.pauseTime_tb.Size = new System.Drawing.Size(131, 22);
            ...
            this.panel3.Location = new System.Drawing.Point(95, 155);
            ...
            this.useSpeed_cb.Location = new System.Drawing.Point(3, 7);
            this.useSpeed_cb.Margin = new System.Windows.Forms.Padding(4);
            this.useSpeed_cb.Name = "useSpeed_cb";
            this.useSpeed_cb.Size = new System.Drawing.Size(18, 17);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.sNodeSpeed_tb.Location = new System.Drawing.Point(28, 2);
            this.sNodeSpeed_tb.Margin = new System.Windows.Forms.Padding(4);
            this.sNodeSpeed_tb.Name = "sNodeSpeed_tb";
            this.sNodeSpeed_tb.Size = new System.Drawing.Size(128, 22);
            ...
            this.label57.Location = new System.Drawing.Point(5, 109);
            ...
            this.animation_lbl.Location = new System.Drawing.Point(5, 67);
            this.animation_lbl.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.animation_lbl.Name = "animation_lbl";
            this.animation_lbl.Size = new System.Drawing.Size(70, 17);
            ...
            this.label63.Location = new System.Drawing.Point(5, 225);
            this.label63.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label63.Name = "label63";
            this.label63.Size = new System.Drawing.Size(37, 17);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.sNodeW1_tb.Location = new System.Drawing.Point(95, 229);
            this.sNodeW1_tb.Margin = new System.Windows.Forms.Padding(4);
            this.sNodeW1_tb.Name = "sNodeW1_tb";
            this.sNodeW1_tb.Size = new System.Drawing.Size(165, 22);
            ...
            this.button5.Size = new System.Drawing.Size(261, 31);
            ...
            this.nodeProperties_gb.Location = new System.Drawing.Point(5, 463);
            this.nodeProperties_gb.Margin = new System.Windows.Forms.Padding(4);
            this.nodeProperties_gb.Name = "nodeProperties_gb";
            this.nodeProperties_gb.Size = new System.Drawing.Size(267, 119);
            ...
            this.nodeProperties_lp.Location = new System.Drawing.Point(0, 31);
            ...
            this.nodeProperties_lp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
            this.nodeProperties_lp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
            this.nodeProperties_lp.Size = new System.Drawing.Size(267, 84);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.nodeX_tb.Location = new System.Drawing.Point(101, 1);
            this.nodeX_tb.Margin = new System.Windows.Forms.Padding(0);
            this.nodeX_tb.Name = "nodeX_tb";
            this.nodeX_tb.Size = new System.Drawing.Size(165, 22);
            ...
            this.label54.Location = new System.Drawing.Point(5, 55);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.nodeY_tb.Location = new System.Drawing.Point(101, 28);
            this.nodeY_tb.Margin = new System.Windows.Forms.Padding(0);
            this.nodeY_tb.Name = "nodeY_tb";
            this.nodeY_tb.Size = new System.Drawing.Size(165, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.nodeZ_tb.Location = new System.Drawing.Point(101, 55);
            this.nodeZ_tb.Margin = new System.Windows.Forms.Padding(0);
            this.nodeZ_tb.Name = "nodeZ_tb";
            this.nodeZ_tb.Size = new System.Drawing.Size(165, 22);
            ...
            this.col_selPath_btn.Location = new System.Drawing.Point(-1, -7);
            this.col_selPath_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_selPath_btn.Name = "col_selPath_btn";
            this.col_selPath_btn.Size = new System.Drawing.Size(285, 28);
            ...
            this.pathObject_gb.Location = new System.Drawing.Point(7, 25);
            this.pathObject_gb.Margin = new System.Windows.Forms.Padding(4);
            this.pathObject_gb.Name = "pathObject_gb";
            this.pathObject_gb.Padding = new System.Windows.Forms.Padding(4);
            this.pathObject_gb.Size = new System.Drawing.Size(267, 62);
            ...
            this.tableLayoutPanel16.Location = new System.Drawing.Point(8, 17);
            ...
            this.tableLayoutPanel16.Size = new System.Drawing.Size(253, 33);
            this.tableLayoutPanel16.TabIndex = 61;
            // 
            // label60
            // 
            this.label60.AutoSize = true;
            this.label60.Location = new System.Drawing.Point(4, 0);
            ...
            this.objectNode_tb.Location = new System.Drawing.Point(119, 4);
            this.objectNode_tb.Margin = new System.Windows.Forms.Padding(4);
            this.objectNode_tb.Name = "objectNode_tb";
            this.objectNode_tb.Size = new System.Drawing.Size(130, 22);
            ...
            this.path_dgv.Location = new System.Drawing.Point(7, 114);
            this.path_dgv.Margin = new System.Windows.Forms.Padding(4, 4, 4, 37);
            ...
            this.path_dgv.Size = new System.Drawing.Size(263, 106);
            ...
            this.col_obj_details_btn.Location = new System.Drawing.Point(0, 930);
            this.col_obj_details_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_obj_details_btn.Name = "col_obj_details_btn";
            this.col_obj_details_btn.Size = new System.Drawing.Size(280, 28);
            ...
            this.col_cam_btn.Location = new System.Drawing.Point(0, 1356);
            this.col_cam_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_cam_btn.Name = "col_cam_btn";
            this.col_cam_btn.Size = new System.Drawing.Size(280, 28);
            ...
            this.cam3_gb.Location = new System.Drawing.Point(4, 1388);
            this.cam3_gb.Margin = new System.Windows.Forms.Padding(4);
            this.cam3_gb.Name = "cam3_gb";
            this.cam3_gb.Padding = new System.Windows.Forms.Padding(4);
            this.cam3_gb.Size = new System.Drawing.Size(273, 465);
            ...
            this.tableLayoutPanel10.Location = new System.Drawing.Point(4, 49);
            ...
            this.tableLayoutPanel10.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 7.692307F));
            this.tableLayoutPanel10.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 7.692307F));
            this.tableLayoutPanel10.Size = new System.Drawing.Size(259, 407);
            ...
            this.label34.Location = new System.Drawing.Point(5, 63);
            ...
            this.label35.Location = new System.Drawing.Point(5, 32);
            ...
            // camFDist_tb
            // 
            this.camFDist_tb.Location = new System.Drawing.Point(120, 377);
            this.camFDist_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camFDist_tb.Name = "camFDist_tb";
            this.camFDist_tb.Size = new System.Drawing.Size(132, 22);
            ...
            // camCDist_tb
            // 
            this.camCDist_tb.Location = new System.Drawing.Point(120, 346);
            this.camCDist_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camCDist_tb.Name = "camCDist_tb";
            this.camCDist_tb.Size = new System.Drawing.Size(132, 22);
            ...
            this.label49.Location = new System.Drawing.Point(5, 373);
            ...
            this.label48.Location = new System.Drawing.Point(5, 342);
            ...
            // camZ_tb
            // 
            this.camZ_tb.Location = new System.Drawing.Point(120, 67);
            this.camZ_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camZ_tb.Name = "camZ_tb";
            this.camZ_tb.Size = new System.Drawing.Size(132, 22);
            ...
            // camY_tb
            // 
            this.camY_tb.Location = new System.Drawing.Point(120, 36);
            this.camY_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camY_tb.Name = "camY_tb";
            this.camY_tb.Size = new System.Drawing.Size(132, 22);
            ...
            // camX_tb
            // 
            this.camX_tb.Location = new System.Drawing.Point(120, 5);
            this.camX_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camX_tb.Name = "camX_tb";
            this.camX_tb.Size = new System.Drawing.Size(132, 22);
            ...
            this.label43.Location = new System.Drawing.Point(5, 94);
            ...
            // camHSpeed_tb
            // 
            this.camHSpeed_tb.Location = new System.Drawing.Point(120, 98);
            this.camHSpeed_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camHSpeed_tb.Name = "camHSpeed_tb";
            this.camHSpeed_tb.Size = new System.Drawing.Size(132, 22);
            ...
            this.label44.Location = new System.Drawing.Point(5, 125);
            ...
            // camVSpeed_tb
            // 
            this.camVSpeed_tb.Location = new System.Drawing.Point(120, 129);
            this.camVSpeed_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camVSpeed_tb.Name = "camVSpeed_tb";
            this.camVSpeed_tb.Size = new System.Drawing.Size(132, 22);
            ...
            this.label45.Location = new System.Drawing.Point(5, 156);
            ...
            // camRotation_tb
            // 
            this.camRotation_tb.Location = new System.Drawing.Point(120, 160);
            this.camRotation_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camRotation_tb.Name = "camRotation_tb";
            this.camRotation_tb.Size = new System.Drawing.Size(132, 22);
            ...
            // camAccel_tb
            // 
            this.camAccel_tb.Location = new System.Drawing.Point(120, 191);
            this.camAccel_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camAccel_tb.Name = "camAccel_tb";
            this.camAccel_tb.Size = new System.Drawing.Size(132, 22);
            ...
            this.label36.Location = new System.Drawing.Point(5, 218);
            ...
            // camPitch_tb
            // 
            this.camPitch_tb.Location = new System.Drawing.Point(120, 222);
            this.camPitch_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camPitch_tb.Name = "camPitch_tb";
            this.camPitch_tb.Size = new System.Drawing.Size(132, 22);
            ...
            // camYaw_tb
            // 
            this.camYaw_tb.Location = new System.Drawing.Point(120, 253);
            this.camYaw_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camYaw_tb.Name = "camYaw_tb";
            this.camYaw_tb.Size = new System.Drawing.Size(132, 22);
            ...
            // camRoll_tb
            // 
            this.camRoll_tb.Location = new System.Drawing.Point(120, 284);
            this.camRoll_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camRoll_tb.Name = "camRoll_tb";
            this.camRoll_tb.Size = new System.Drawing.Size(132, 22);
            ...
            // cam3A5_tb
            // 
            this.cam3A5_tb.Location = new System.Drawing.Point(120, 315);
            this.cam3A5_tb.Margin = new System.Windows.Forms.Padding(4);
            this.cam3A5_tb.Name = "cam3A5_tb";
            this.cam3A5_tb.Size = new System.Drawing.Size(132, 22);
            ...
            this.label37.Location = new System.Drawing.Point(5, 249);
            ...
            this.label38.Location = new System.Drawing.Point(5, 280);
            ...
            this.label47.Location = new System.Drawing.Point(5, 311);
            ...
            this.label39.Location = new System.Drawing.Point(163, 20);
            ...
            // camID_tb
            // 
            this.camID_tb.Location = new System.Drawing.Point(95, 16);
            this.camID_tb.Margin = new System.Windows.Forms.Padding(4);
            this.camID_tb.Name = "camID_tb";
            this.camID_tb.Size = new System.Drawing.Size(59, 22);
            ...
            this.col_replacemodel_btn.Location = new System.Drawing.Point(0, 1857);
            this.col_replacemodel_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_replacemodel_btn.Name = "col_replacemodel_btn";
            this.col_replacemodel_btn.Size = new System.Drawing.Size(280, 28);
            ...
            this.col_levelbounds_btn.Location = new System.Drawing.Point(0, 2023);
            this.col_levelbounds_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_levelbounds_btn.Name = "col_levelbounds_btn";
            this.col_levelbounds_btn.Size = new System.Drawing.Size(280, 28);
            ...
            this.bounds_gb.Location = new System.Drawing.Point(4, 2055);
            this.bounds_gb.Margin = new System.Windows.Forms.Padding(4);
            this.bounds_gb.Name = "bounds_gb";
            this.bounds_gb.Padding = new System.Windows.Forms.Padding(4);
            this.bounds_gb.Size = new System.Drawing.Size(267, 187);
            ...
            // updateBounds_btn
            // 
            this.updateBounds_btn.Location = new System.Drawing.Point(159, 151);
            this.updateBounds_btn.Margin = new System.Windows.Forms.Padding(4);
            this.updateBounds_btn.Name = "updateBounds_btn";
            this.updateBounds_btn.Size = new System.Drawing.Size(100, 28);
            ...
            this.tableLayoutPanel8.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
            this.tableLayoutPanel8.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
            this.tableLayoutPanel8.Size = new System.Drawing.Size(253, 102);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.minZ_Bounds_tb.Location = new System.Drawing.Point(58, 72);
            this.minZ_Bounds_tb.Margin = new System.Windows.Forms.Padding(4);
            this.minZ_Bounds_tb.Name = "minZ_Bounds_tb";
            this.minZ_Bounds_tb.Size = new System.Drawing.Size(62, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.minY_Bounds_tb.Location = new System.Drawing.Point(58, 38);
            this.minY_Bounds_tb.Margin = new System.Windows.Forms.Padding(4);
            this.minY_Bounds_tb.Name = "minY_Bounds_tb";
            this.minY_Bounds_tb.Size = new System.Drawing.Size(62, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.minX_Bounds_tb.Location = new System.Drawing.Point(58, 4);
            this.minX_Bounds_tb.Margin = new System.Windows.Forms.Padding(4);
            this.minX_Bounds_tb.Name = "minX_Bounds_tb";
            this.minX_Bounds_tb.Size = new System.Drawing.Size(62, 22);
            ...
            this.label26.Location = new System.Drawing.Point(128, 34);
            ...
            // maxX_Bounds_tb
            // 
            this.maxX_Bounds_tb.Location = new System.Drawing.Point(191, 4);
            this.maxX_Bounds_tb.Margin = new System.Windows.Forms.Padding(4);
            this.maxX_Bounds_tb.Name = "maxX_Bounds_tb";
            this.maxX_Bounds_tb.Size = new System.Drawing.Size(56, 22);
            ...
            // maxY_Bounds_tb
            // 
            this.maxY_Bounds_tb.Location = new System.Drawing.Point(191, 38);
            this.maxY_Bounds_tb.Margin = new System.Windows.Forms.Padding(4);
            this.maxY_Bounds_tb.Name = "maxY_Bounds_tb";
            this.maxY_Bounds_tb.Size = new System.Drawing.Size(56, 22);
            ...
            // maxZ_Bounds_tb
            // 
            this.maxZ_Bounds_tb.Location = new System.Drawing.Point(191, 72);
            this.maxZ_Bounds_tb.Margin = new System.Windows.Forms.Padding(4);
            this.maxZ_Bounds_tb.Name = "maxZ_Bounds_tb";
            this.maxZ_Bounds_tb.Size = new System.Drawing.Size(56, 22);
            ...
            this.label28.Location = new System.Drawing.Point(163, 20);
            ...
            this.col_levelentries_btn.Location = new System.Drawing.Point(0, 2246);
            this.col_levelentries_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_levelentries_btn.Name = "col_levelentries_btn";
            this.col_levelentries_btn.Size = new System.Drawing.Size(280, 28);
            ...
            this.levelEntries_gb.Location = new System.Drawing.Point(4, 2278);
            this.levelEntries_gb.Margin = new System.Windows.Forms.Padding(4);
            this.levelEntries_gb.Name = "levelEntries_gb";
            this.levelEntries_gb.Padding = new System.Windows.Forms.Padding(4);
            this.levelEntries_gb.Size = new System.Drawing.Size(276, 185);
            ...
            this.levelEntries_dgv.Location = new System.Drawing.Point(9, 14);
            this.levelEntries_dgv.Margin = new System.Windows.Forms.Padding(4, 4, 4, 37);
            ...
            this.levelEntries_dgv.Size = new System.Drawing.Size(259, 164);
            ...
            this.col_objects_btn.Location = new System.Drawing.Point(0, 2467);
            this.col_objects_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_objects_btn.Name = "col_objects_btn";
            this.col_objects_btn.Size = new System.Drawing.Size(280, 28);
            ...
            this.objects_gb.Location = new System.Drawing.Point(4, 2499);
            this.objects_gb.Margin = new System.Windows.Forms.Padding(4);
            this.objects_gb.Name = "objects_gb";
            this.objects_gb.Padding = new System.Windows.Forms.Padding(4);
            this.objects_gb.Size = new System.Drawing.Size(276, 298);
            ...
            this.objects_dgv.Location = new System.Drawing.Point(9, 14);
            this.objects_dgv.Margin = new System.Windows.Forms.Padding(4, 4, 4, 37);
            ...
            this.objects_dgv.Size = new System.Drawing.Size(259, 270);
            ...
            this.col_structs_btn.Location = new System.Drawing.Point(0, 2801);
            this.col_structs_btn.Margin = new System.Windows.Forms.Padding(0);
            this.col_structs_btn.Name = "col_structs_btn";
            this.col_structs_btn.Size = new System.Drawing.Size(280, 28);
            ...
            this.structs_gb.Location = new System.Drawing.Point(4, 2833);
            this.structs_gb.Margin = new System.Windows.Forms.Padding(4);
            this.structs_gb.Name = "structs_gb";
            this.structs_gb.Padding = new System.Windows.Forms.Padding(4);
            this.structs_gb.Size = new System.Drawing.Size(276, 298);
            ...
            this.structs_dgv.Location = new System.Drawing.Point(9, 14);
            this.structs_dgv.Margin = new System.Windows.Forms.Padding(4, 4, 4, 37);
            ...
            this.structs_dgv.Size = new System.Drawing.Size(259, 270);
            ...
            this.label30.Size = new System.Drawing.Size(208, 17);
            ...
            this.label31.Size = new System.Drawing.Size(35, 34);
            ...
            // cameraMenu
            // 
            this.cameraMenu.ImageScalingSize = new System.Drawing.Size(20, 20);
            ...
            this.cameraMenu.Size = new System.Drawing.Size(248, 76);
            ...
            this.createCameraToolStripMenuItem.Size = new System.Drawing.Size(247, 24);
            ...
            this.createGameplayCameraToolStripMenuItem.Size = new System.Drawing.Size(247, 24);
            ...
            this.createGameplayTiggerToolStripMenuItem.Size = new System.Drawing.Size(247, 24);
            ...
            this.textBox2.Size = new System.Drawing.Size(14, 22);
            ...
            this.label56.Size = new System.Drawing.Size(14, 17);
            ...
            this.toolStrip1.Size = new System.Drawing.Size(1587, 30);
            this.toolStrip1.TabIndex = 74;
            // 
            // mode_lbl
            // 
            this.mode_lbl.Name = "mode_lbl";
            this.mode_lbl.Size = new System.Drawing.Size(48, 27);
            ...
            this.mode_cb.Size = new System.Drawing.Size(132, 30);
            ...
            this.rectSelect_btn.Size = new System.Drawing.Size(123, 27);
            ...
            this.cam_moveToCurrent_btn.Size = new System.Drawing.Size(129, 27);
            ...
            this.obj_move_btn.Size = new System.Drawing.Size(50, 27);
            ...
            this.obj_rot_btn.Size = new System.Drawing.Size(57, 27);
            ...
            this.obj_scale_btn.Size = new System.Drawing.Size(48, 27);
            ...
            this.obj_duplicate_btn.Size = new System.Drawing.Size(77, 27);
            ...
            this.cam_yaw_btn.Size = new System.Drawing.Size(39, 27);
            ...
            this.cam_pitch_btn.Size = new System.Drawing.Size(45, 27);
            ...
            this.cam_roll_btn.Size = new System.Drawing.Size(39, 27);
            ...
            this.deselect_btn.Size = new System.Drawing.Size(70, 27);
            ...
            this.delete_btn.Size = new System.Drawing.Size(57, 27);
            ...
            this.yOffset_tb.Size = new System.Drawing.Size(52, 27);
            this.yOffset_tb.Text = "0";
            ...
            this.lockZ_btn.Size = new System.Drawing.Size(43, 27);
            ...
            this.lockY_btn.Size = new System.Drawing.Size(43, 27);
            ...
            this.lockX_btn.Size = new System.Drawing.Size(44, 27);
            ...
            this.assignObject_btn.Size = new System.Drawing.Size(85, 27);
            ...
            this.moveNode_btn.Size = new System.Drawing.Size(91, 27);
            ...
            this.linkMode_btn.Size = new System.Drawing.Size(39, 27);
            ...
            this.removeNode_btn.Size = new System.Drawing.Size(80, 27);
            ...
            this.endNode_btn.Size = new System.Drawing.Size(79, 27);
            ...
            this.startNewPath_btn.Size = new System.Drawing.Size(75, 24);
            ...
            this.addNode_btn.Size = new System.Drawing.Size(82, 24);
            ...
            this.addControllerNode_btn.Size = new System.Drawing.Size(143, 24);
            ...
            this.deselectPath_btn.Size = new System.Drawing.Size(102, 24);
            ...
            this.deletePath_btn.Size = new System.Drawing.Size(89, 24);
            ...
            this.eraseAll_btn.Size = new System.Drawing.Size(70, 24);
            ...
            this.button3.Location = new System.Drawing.Point(1280, 33);
            ...
            this.bgA_cb.Location = new System.Drawing.Point(5, 5);
            this.bgA_cb.Margin = new System.Windows.Forms.Padding(4);
            this.bgA_cb.Name = "bgA_cb";
            this.bgA_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.bgB_btn.Location = new System.Drawing.Point(5, 36);
            this.bgB_btn.Margin = new System.Windows.Forms.Padding(4);
            this.bgB_btn.Name = "bgB_btn";
            this.bgB_btn.Size = new System.Drawing.Size(18, 17);
            ...
            this.objs_cb.Location = new System.Drawing.Point(5, 67);
            this.objs_cb.Margin = new System.Windows.Forms.Padding(4);
            this.objs_cb.Name = "objs_cb";
            this.objs_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.label59.Location = new System.Drawing.Point(33, 32);
            ...
            this.label51.Location = new System.Drawing.Point(33, 1);
            ...
            this.label64.Location = new System.Drawing.Point(33, 63);
            ...
            this.label65.Location = new System.Drawing.Point(33, 94);
            ...
            this.cameras_cb.Location = new System.Drawing.Point(5, 98);
            this.cameras_cb.Margin = new System.Windows.Forms.Padding(4);
            this.cameras_cb.Name = "cameras_cb";
            this.cameras_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 25F));
            this.tableLayoutPanel1.Size = new System.Drawing.Size(268, 369);
            this.tableLayoutPanel1.TabIndex = 81;
            // 
            // levelBoundAlpha_cb
            // 
            this.levelBoundAlpha_cb.AutoSize = true;
            this.levelBoundAlpha_cb.Location = new System.Drawing.Point(5, 191);
            this.levelBoundAlpha_cb.Margin = new System.Windows.Forms.Padding(4);
            this.levelBoundAlpha_cb.Name = "levelBoundAlpha_cb";
            this.levelBoundAlpha_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.levelStats_cb.Location = new System.Drawing.Point(5, 129);
            this.levelStats_cb.Margin = new System.Windows.Forms.Padding(4);
            this.levelStats_cb.Name = "levelStats_cb";
            this.levelStats_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.label58.Location = new System.Drawing.Point(33, 156);
            ...
            this.levelBound_cb.Location = new System.Drawing.Point(5, 160);
            this.levelBound_cb.Margin = new System.Windows.Forms.Padding(4);
            this.levelBound_cb.Name = "levelBound_cb";
            this.levelBound_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.label75.Location = new System.Drawing.Point(33, 342);
            this.label75.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label75.Name = "label75";
            this.label75.Size = new System.Drawing.Size(159, 17);
            ...
            this.unknownRadius_cb.Location = new System.Drawing.Point(5, 346);
            this.unknownRadius_cb.Margin = new System.Windows.Forms.Padding(4);
            this.unknownRadius_cb.Name = "unknownRadius_cb";
            this.unknownRadius_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.flagRadius_cb.Location = new System.Drawing.Point(33, 311);
            this.flagRadius_cb.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.flagRadius_cb.Name = "flagRadius_cb";
            this.flagRadius_cb.Size = new System.Drawing.Size(83, 17);
            ...
            this.showFlagRadius_cb.Location = new System.Drawing.Point(5, 315);
            this.showFlagRadius_cb.Margin = new System.Windows.Forms.Padding(4);
            this.showFlagRadius_cb.Name = "showFlagRadius_cb";
            this.showFlagRadius_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.label72.Location = new System.Drawing.Point(33, 280);
            ...
            this.enemyRadius_cb.Location = new System.Drawing.Point(5, 284);
            this.enemyRadius_cb.Margin = new System.Windows.Forms.Padding(4);
            this.enemyRadius_cb.Name = "enemyRadius_cb";
            this.enemyRadius_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.label71.Location = new System.Drawing.Point(33, 249);
            this.label71.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label71.Name = "label71";
            this.label71.Size = new System.Drawing.Size(90, 17);
            ...
            this.warpRadius_cb.Location = new System.Drawing.Point(5, 253);
            this.warpRadius_cb.Margin = new System.Windows.Forms.Padding(4);
            this.warpRadius_cb.Name = "warpRadius_cb";
            this.warpRadius_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.label66.Location = new System.Drawing.Point(33, 218);
            this.label66.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label66.Name = "label66";
            this.label66.Size = new System.Drawing.Size(155, 17);
            ...
            this.camTrigger_cb.Location = new System.Drawing.Point(5, 222);
            this.camTrigger_cb.Margin = new System.Windows.Forms.Padding(4);
            this.camTrigger_cb.Name = "camTrigger_cb";
            this.camTrigger_cb.Size = new System.Drawing.Size(18, 17);
            ...
            this.flowLayoutPanel2.Location = new System.Drawing.Point(1280, 63);
            this.flowLayoutPanel2.Margin = new System.Windows.Forms.Padding(4);
            this.flowLayoutPanel2.Name = "flowLayoutPanel2";
            this.flowLayoutPanel2.Size = new System.Drawing.Size(305, 125);
            this.flowLayoutPanel2.TabIndex = 83;
            // 
            // drawDist_tb
            // 
            this.drawDist_tb.Location = new System.Drawing.Point(1196, 4);
            this.drawDist_tb.Margin = new System.Windows.Forms.Padding(4);
            this.drawDist_tb.Name = "drawDist_tb";
            this.drawDist_tb.Size = new System.Drawing.Size(69, 22);
            ...
            this.label12.Location = new System.Drawing.Point(1040, 7);
            ...
            this.LevelViewer.Location = new System.Drawing.Point(0, 33);
            this.LevelViewer.Margin = new System.Windows.Forms.Padding(5);
            this.LevelViewer.Name = "LevelViewer";
            this.LevelViewer.Size = new System.Drawing.Size(1276, 583);
            ...
            this.ClientSize = new System.Drawing.Size(1587, 652);
