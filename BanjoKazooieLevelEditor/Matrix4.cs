...
namespace BanjoKazooieLevelEditor
{
  public class Matrix4 : Matrix
  {
    ...
    public static bool IsEqual(Matrix4 m1, Matrix4 m2)
    {
      return (double) m1.matrix[0, 0] == (double) m2.matrix[0, 0] && (double) m1.matrix[0, 1] == (double) m2.matrix[0, 1] && ((double) m1.matrix[0, 2] == (double) m2.matrix[0, 2] && (double) m1.matrix[0, 3] == (double) m2.matrix[0, 3]) && ((double) m1.matrix[1, 0] == (double) m2.matrix[1, 0] && (double) m1.matrix[1, 1] == (double) m2.matrix[1, 1] && ((double) m1.matrix[1, 2] == (double) m2.matrix[1, 2] && (double) m1.matrix[1, 3] == (double) m2.matrix[1, 3])) && ((double) m1.matrix[2, 0] == (double) m2.matrix[2, 0] && (double) m1.matrix[2, 1] == (double) m2.matrix[2, 1] && ((double) m1.matrix[2, 2] == (double) m2.matrix[2, 2] && (double) m1.matrix[2, 3] == (double) m2.matrix[2, 3]) && ((double) m1.matrix[3, 0] == (double) m2.matrix[3, 0] && (double) m1.matrix[3, 1] == (double) m2.matrix[3, 1] && ((double) m1.matrix[3, 2] == (double) m2.matrix[3, 2] && (double) m1.matrix[3, 3] == (double) m2.matrix[3, 3])));
    }
    ...
    {
      return new Matrix4(Matrix.Multiply((Matrix) m, scalar));
    }
