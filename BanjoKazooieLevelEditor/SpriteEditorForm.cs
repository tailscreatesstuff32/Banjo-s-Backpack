...
namespace BanjoKazooieLevelEditor
{
  public class SpriteEditorForm : Form
  {
      ...
      if (this.sprites_dgv.SelectedRows.Count > 0)
      {
        if (this.newSprite != null)
        {
          try
          {
            ...
            FileStream fileStream = File.Create(this.outDir + this.selectedSprite.pointer.ToString("x"));
    ...
    private void sprites_dgv_SelectionChanged(object sender, EventArgs e)
    {
      this.ShowSelectedSprite();
    }
