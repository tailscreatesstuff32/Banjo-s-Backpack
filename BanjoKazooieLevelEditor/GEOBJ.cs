...
namespace BanjoKazooieLevelEditor
{
  internal class GEOBJ
  {
    ...
    {
      return "f " + (object) v1 + "/" + (object) vtIndex + " " + (object) v2 + "/" + (object) (vtIndex + 1) + " " + (object) v3 + "/" + (object) (vtIndex + 2) + Environment.NewLine + "#fvcolorindex " + (object) v1 + " " + (object) v2 + " " + (object) v3 + Environment.NewLine;
    }
