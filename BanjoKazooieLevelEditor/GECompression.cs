...
namespace BanjoKazooieLevelEditor
{
  public class GECompression
  {
    ...
    private uint GetNBits(int nBits)
    {
      ...
      int num = (int) (uint) ((ulong) this.bitsCache & (ulong) ((1 << nBits) - 1));
    ...
    private bool IsFileExist(string lpszFilename)
    {
      return File.Exists(lpszFilename);
    }
    ...
    public bool CompressGZipFile(string inputFile, string outputFile, bool byteFlipCompressed)
    {
      ...
      {
        num1 = Convert.ToUInt32(binaryReader.BaseStream.Length);
        if (num1 == 0U)
          return false;
        numArray = binaryReader.ReadBytes((int) num1);
      }
      byte[] buffer1 = new byte[(int) num1 + 16];
      for (int index = 0; (long) index < (long) (num1 + 16U); ++index)
      ...
      using (BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Open(this.mainFolder + "tempgh9.bin", FileMode.Create)))
      {
        ...
        {
          int num3 = (int) num2;
          num2 = (uint) (num3 - (int) ((uint) num3 % 16U) + 16);
        }
        binaryWriter.Write(buffer1, 0, (int) num2);
      }
      ...
      if (this.IsFileExist(str3))
      {
        ...
        using (BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Open(outputFile, FileMode.Create)))
        {
          ...
          {
            num2 -= 2U;
            buffer2[(int) num2] = (byte) 17;
            buffer2[(int) num2 + 1] = (byte) 114;
          }
          else if (this.game == GECompression.PD)
          {
            num2 -= 5U;
            buffer2[(int) num2] = (byte) 17;
            buffer2[(int) num2 + 1] = (byte) 115;
            buffer2[(int) num2 + 2] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 3] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 4] = (byte) (num1 & (uint) byte.MaxValue);
          }
          else if (this.game == GECompression.BANJOKAZOOIE)
          {
            ...
            buffer2[(int) num2] = (byte) 17;
            buffer2[(int) num2 + 1] = (byte) 114;
            buffer2[(int) num2 + 2] = (byte) (num1 >> 24 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 3] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 4] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 5] = (byte) (num1 & (uint) byte.MaxValue);
          }
          else if (this.game == GECompression.DONKEYKONG64 || this.game == GECompression.BLASTCORPS)
          {
            num2 -= 10U;
            buffer2[(int) num2] = (byte) 31;
            buffer2[(int) num2 + 1] = (byte) 139;
            buffer2[(int) num2 + 2] = (byte) 8;
            buffer2[(int) num2 + 3] = (byte) 0;
            buffer2[(int) num2 + 4] = (byte) 0;
            buffer2[(int) num2 + 5] = (byte) 0;
            buffer2[(int) num2 + 6] = (byte) 0;
            buffer2[(int) num2 + 7] = (byte) 0;
            buffer2[(int) num2 + 8] = (byte) 2;
            buffer2[(int) num2 + 9] = (byte) 3;
          }
          else if (this.game == GECompression.DONKEYKONG64KIOSK)
          {
            ...
            buffer2[(int) num2 + 1] = (byte) 139;
            buffer2[(int) num2 + 2] = (byte) 8;
            buffer2[(int) num2 + 3] = (byte) 8;
            buffer2[(int) num2 + 4] = (byte) 3;
            buffer2[(int) num2 + 5] = (byte) 69;
            buffer2[(int) num2 + 6] = (byte) 117;
            buffer2[(int) num2 + 7] = (byte) 55;
            buffer2[(int) num2 + 8] = (byte) 0;
            buffer2[(int) num2 + 9] = (byte) 3;
            buffer2[(int) num2 + 10] = (byte) 116;
            buffer2[(int) num2 + 11] = (byte) 109;
            buffer2[(int) num2 + 12] = (byte) 112;
            buffer2[(int) num2 + 13] = (byte) 46;
            buffer2[(int) num2 + 14] = (byte) 98;
            buffer2[(int) num2 + 15] = (byte) 105;
            buffer2[(int) num2 + 16] = (byte) 110;
            buffer2[(int) num2 + 17] = (byte) 0;
          }
          else if (this.game == GECompression.BANJOTOOIE)
          {
            num2 -= 2U;
            buffer2[(int) num2] = (byte) 0;
            buffer2[(int) num2 + 1] = (byte) 21;
          }
          else if (this.game == GECompression.CONKER)
          {
            num2 -= 4U;
            buffer2[(int) num2] = (byte) (num1 >> 24 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 1] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 2] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 3] = (byte) (num1 & (uint) byte.MaxValue);
          }
          else if (this.game == GECompression.TOPGEARRALLY)
          {
            num2 -= 14U;
            buffer2[(int) num2] = (byte) ((ulong) ((long) int32 - (long) (num2 + 8U) >> 24) & (ulong) byte.MaxValue);
            buffer2[(int) num2 + 1] = (byte) ((ulong) ((long) int32 - (long) (num2 + 8U) >> 16) & (ulong) byte.MaxValue);
            buffer2[(int) num2 + 2] = (byte) ((ulong) ((long) int32 - (long) (num2 + 8U) >> 8) & (ulong) byte.MaxValue);
            buffer2[(int) num2 + 3] = (byte) ((ulong) int32 - (ulong) (num2 + 8U) & (ulong) byte.MaxValue);
            buffer2[(int) num2 + 4] = (byte) (num1 >> 24 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 5] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 6] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 7] = (byte) (num1 & (uint) byte.MaxValue);
            buffer2[(int) num2 + 8] = (byte) 0;
            buffer2[(int) num2 + 9] = (byte) 0;
            buffer2[(int) num2 + 10] = (byte) 0;
            buffer2[(int) num2 + 11] = (byte) 0;
            buffer2[(int) num2 + 12] = (byte) 0;
            buffer2[(int) num2 + 13] = (byte) 0;
          }
          else if (this.game == GECompression.MILO)
          {
            num2 -= 2U;
            buffer2[(int) num2] = (byte) 120;
            buffer2[(int) num2 + 1] = (byte) 156;
          }
          else if (this.game == GECompression.JFG || this.game == GECompression.JFGKIOSK)
          {
            num2 -= 5U;
            buffer2[(int) num2] = (byte) 4;
            buffer2[(int) num2 + 1] = (byte) 3;
            buffer2[(int) num2 + 2] = (byte) 0;
            buffer2[(int) num2 + 3] = (byte) 0;
            buffer2[(int) num2 + 4] = (byte) 9;
          }
          ...
          if (byteFlipCompressed)
          {
            ...
            for (int index = 0; index < int32; index += 2)
            {
              byte num3 = buffer2[index];
              buffer2[index] = buffer2[index + 1];
              buffer2[index + 1] = num3;
            }
          }
          binaryWriter.Write(buffer2, (int) num2, (int) ((long) int32 - (long) (num2 + 8U)));
          this.compressed_filelen = binaryWriter.BaseStream.Length;
          uint num4 = (uint) ((ulong) int32 - (ulong) (num2 + 8U));
          if (num4 % 8U != 0U)
          {
            if (this.padding)
            {
              for (int index = 0; (long) index < (long) (8U - num4 % 8U); ++index)
              {
      ...
      int num5 = (int) MessageBox.Show("Error Compressing - GZip didn't spit out a file", "Error");
      return false;
    }
      ...
      ref int returnStartIndex)
    {
      ...
      {
        num5 = (int) ((long) num5 + (long) numArray1[index3]);
        numArray2[index3 + 1] = (uint) num5;
      }
      ...
      for (int index3 = 0; index3 < length; ++index3)
      {
        if (bit1TableChoice == this.TABLE1)
        {
          if (this.bt1Table1[index3] != (byte) 0)
          {
            numArray3[(int) numArray2[(int) this.bt1Table1[index3]]] = (uint) num6;
            ++numArray2[(int) this.bt1Table1[index3]];
          }
        }
        else if (bit1TableChoice == this.TABLE2)
        {
          if (this.bt1Table2[index3] != (byte) 0)
          {
            numArray3[(int) numArray2[(int) this.bt1Table2[index3]]] = (uint) num6;
            ++numArray2[(int) this.bt1Table2[index3]];
          }
        }
        else if (bit1TableChoice == this.VARIABLETABLE)
        {
          if (this.variableTable[index3] != (byte) 0)
          {
            numArray3[(int) numArray2[(int) this.variableTable[index3]]] = (uint) num6;
            ++numArray2[(int) this.variableTable[index3]];
          }
        }
        else if (bit1TableChoice == this.WORDTABLEBEGIN)
        {
          if (this.wordTable[index3] != 0U)
          {
            numArray3[(int) numArray2[(int) this.wordTable[index3]]] = (uint) num6;
            ++numArray2[(int) this.wordTable[index3]];
          }
        }
        else if (bit1TableChoice == this.WORDTABLEEND && this.wordTable[(int) this.tableSize + index3] != 0U)
        {
          numArray3[(int) numArray2[(int) this.wordTable[(int) this.tableSize + index3]]] = (uint) num6;
          ++numArray2[(int) this.wordTable[(int) this.tableSize + index3]];
        }
        ++num6;
      }
      int num7 = -numBits;
      ...
      uint num9 = 0;
      int num10 = 0;
      for (int index3 = index1; index3 < index2 + 1; ++index3)
      {
        int num11 = (int) numArray1[index3];
        uint num12 = (uint) (1 << index3 - 1);
        int num13 = length;
        for (; num11 > 0 && num11 >= 0; --num11)
        {
          int num14;
          for (num14 = num7 + numBits; num14 < index3; num14 += numBits)
          {
            ++index5;
            uint num15 = numBits >= index2 - num14 ? (uint) (index2 - num14) : (uint) numBits;
            num9 = (uint) (index3 - num14);
            if (num11 < 1 << (int) num9)
            {
              uint num16 = (uint) ((1 << (int) num9) - num11);
              ++num9;
              for (int index7 = index3 + 1; num9 < num15 && index7 < numArray1.Length; ++index7)
              {
                if (numArray1[index7] < num16 * 2U)
                {
                  ++num9;
                  num16 = num16 * 2U - numArray1[index7];
                }
              }
            }
            if (num1 == -1)
            ...
            ++index6;
            numArray4[index6] = this.unpackTableIndex + 1;
            num10 = this.unpackTableIndex + 1;
            if (index5 != 0)
            {
              numArray2[index5] = (uint) num8;
              ...
              this.unpackTable[(num8 >> num14 - numBits) + numArray4[index5 - 1]].bits = tableEntry.bits;
              this.unpackTable[(num8 >> num14 - numBits) + numArray4[index5 - 1]].flags = tableEntry.flags;
              this.unpackTable[(num8 >> num14 - numBits) + numArray4[index5 - 1]].wordValue = tableEntry.wordValue;
              this.unpackTable[(num8 >> num14 - numBits) + numArray4[index5 - 1]].nextIndex = tableEntry.nextIndex;
            }
            this.unpackTableIndex += (1 << (int) num9) + 1;
          }
          num7 = num14 - numBits;
          tableEntry.bits = (uint) (index3 - num7);
          tableEntry.nextIndex = 0;
          if (index4 >= num13)
          {
          ...
          {
            uint num15 = numArray3[index4];
            if ((long) num15 < (long) size2)
            {
              tableEntry.flags = num15 < 256U ? (byte) 16 : (byte) 15;
              tableEntry.wordValue = num15;
            }
            else if (bit12STableSChoice == this.TABLE1)
            {
              tableEntry.flags = (byte) this.bt12Table1B[(long) numArray3[index4] - (long) size2];
              tableEntry.wordValue = (uint) this.bt12Table1S[(long) numArray3[index4] - (long) size2];
            }
            else if (bit12STableSChoice == this.TABLE2)
            {
              tableEntry.flags = (byte) this.bt12Table2B[(long) numArray3[index4] - (long) size2];
              tableEntry.wordValue = (uint) this.bt12Table2S[(long) numArray3[index4] - (long) size2];
            }
            else
            {
          ...
          uint num17 = (uint) (num8 >> num7);
          uint num18 = (uint) (1 << index3 - num7);
          for (; (long) (1 << (int) num9) > (long) num17; num17 += num18)
          {
            if ((long) num10 + (long) num17 > (long) ushort.MaxValue)
              return;
            this.unpackTable[(long) num10 + (long) num17].bits = tableEntry.bits;
            this.unpackTable[(long) num10 + (long) num17].flags = tableEntry.flags;
            this.unpackTable[(long) num10 + (long) num17].wordValue = tableEntry.wordValue;
            this.unpackTable[(long) num10 + (long) num17].nextIndex = tableEntry.nextIndex;
          }
          uint num19;
          for (num19 = num12; ((long) num8 & (long) num19) > 0L; num19 >>= 1)
            num8 = (int) ((long) num8 ^ (long) num19);
          for (num8 = (int) ((long) num8 ^ (long) num19); (long) (num8 & (1 << num7) - 1) != (long) numArray2[index5]; num7 = 0)
            --index5;
        }
      }
      if (num4 > 0U)
